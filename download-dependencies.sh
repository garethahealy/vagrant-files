...
if [ ! -f $HOME/.m2/repository/org/apache/activemq/activemq-artemis/1.4.0/activemq-artemis-1.4.0-bin.zip ]; then
    wget https://www.apache.org/dist/activemq/activemq-artemis/1.4.0/apache-artemis-1.4.0-bin.zip
    mvn install:install-file -Dfile=apache-artemis-1.4.0-bin.zip -DgroupId=org.apache.activemq -DartifactId=activemq-artemis -Dversion=1.4.0 -Dpackaging=zip -Dclassifier=bin
fi

ls -lrt $HOME/.m2/repository/org/apache/activemq/activemq-artemis/1.4.0/activemq-artemis-1.4.0-bin.zip
